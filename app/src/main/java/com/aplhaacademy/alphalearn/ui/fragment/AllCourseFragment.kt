...
import com.aplhaacademy.alphalearn.databinding.FragmentAllCourseBinding
import com.aplhaacademy.alphalearn.ui.course.CourseDetailActivity

class AllCourseFragment : Fragment() {

    private var _binding: FragmentAllCourseBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentAllCourseBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun getDataForAll(): ArrayList<CourseTopic> {
        return ArrayList(CourseData.getAllData())
    }
}