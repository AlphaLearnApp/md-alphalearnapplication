...
import com.aplhaacademy.alphalearn.databinding.FragmentMathematicsBinding
...
class MathematicsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val courseData = getDataForMathematics()
    ...
    private fun getDataForMathematics(): ArrayList<CourseTopic> {
        return ArrayList(CourseData.getMathematicsData())
    }
}