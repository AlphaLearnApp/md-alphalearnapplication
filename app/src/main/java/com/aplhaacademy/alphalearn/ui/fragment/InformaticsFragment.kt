...
import com.aplhaacademy.alphalearn.databinding.FragmentInformaticsBinding
import com.aplhaacademy.alphalearn.ui.course.CourseDetailActivity

class InformaticsFragment : Fragment() {

    private var _binding: FragmentInformaticsBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentInformaticsBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val courseData = getDataForInformatics()
    ...
    private fun getDataForInformatics(): ArrayList<CourseTopic> {
        return ArrayList(CourseData.getInformaticsData())
    }
}